    ...
    return (
      <section className="p-12 min-h-screen bg-gradient-to-r from-purple-600 via-blue-500 to-pink-500 text-white flex flex-col justify-center items-center">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-6xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-red-600 animate__animated animate__pulse animate__infinite">
            About Me
          </h2>
          <p className="text-2xl leading-relaxed mb-6">
            I am Hurya, a passionate web developer and student, focused on building modern web applications. I specialize in technologies like React, Next.js, and TypeScript, creating dynamic, user-friendly applications. I am also excited to dive into the world of AI and Metaverse, exploring how they can transform the digital landscape.
          </p>
